...
class SalarySlip extends Model
{
    ...
    protected $fillable = [
        ...
        'other_deductions', 'other_deduction_note', 'reimbursements', 'reimbursement_lines', 'leave_covered_days', 'leave_overdrawn_days', 'present_days', 'net_salary',
    ...
    protected function casts(): array
    {
        return [
            ...
            'leave_overdrawn_days' => 'decimal:2',
