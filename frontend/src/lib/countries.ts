/**
 * Every dialling code in the world, with the country it belongs to.
 *
 * Generated, not typed: two hundred and forty-five codes written by hand
 * is two hundred and forty-five chances to be quietly wrong about somewhere
 * nobody on the team dials. The source is libphonenumber (Google's phone
 * metadata, the same data Android dials with); the names come from the
 * browser's own region names.
 *
 * To regenerate after a country changes its code:
 *   npm install --no-save libphonenumber-js
 *   node scripts/generate-countries.cjs   (see that file)
 */
export interface Country {
  /** ISO 3166-1 alpha-2 — also what the flag is drawn from. */
  iso: string
  name: string
...
export const COUNTRIES: Country[] = [
  ...
  { iso: 'TA', name: "Tristan da Cunha", dial: '290' },
...
/**
 * The flag, from the country code itself: two letters shifted into the
 * regional-indicator block become the flag the reader's own system draws.
 * No image files, no sprite sheet, nothing to keep up to date.
 */
